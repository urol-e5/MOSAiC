...
data_urls <- list(
  Apul = list(
    ...
    gene-meth = "https://raw.githubusercontent.com/urol-e5/timeseries-molecular-calcification/refs/heads/main/D-Apul/output/40-Apul-Gene-Methylation/Apul-gene-methylation_75pct.tsv"
  ),
  Peve = list(
    ...
    gene-meth = "https://raw.githubusercontent.com/urol-e5/timeseries-molecular-calcification/refs/heads/main/E-Peve/output/15-Peve-Gene-Methylation/Peve-gene-methylation_75pct.tsv"
  ),
  Ptuh = list(
    ...
    gene-meth = "https://raw.githubusercontent.com/urol-e5/timeseries-molecular-calcification/refs/heads/main/F-Ptua/output/09-Ptua-Gene-Methylation/Ptua-gene-methylation_75pct.tsv"
  )
)
...
for (species_code in names(data_urls)) {
  ...
  for (data_type in c("gene", "epimachine", "mirna", "lncRNA", "mCpG", "gene-meth")) {

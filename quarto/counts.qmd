...
if (nrow(feature_counts_data) > 0) {
  feature_counts_data |>
    ...
    fmt_number(columns = c("Gene", "Epimachine", "miRNA", "lncRNA", "mCpG"), decimals = 0) |>
    cols_align(align = "center", columns = c("Gene", "Epimachine", "miRNA", "lncRNA", "mCpG")) |>
    tab_style(
      style = cell_text(weight = "bold"),
      locations = cells_body(columns = c("Gene", "Epimachine", "miRNA", "lncRNA", "mCpG"))
    ) |>
    print()
} else {
...
for (species_code in names(data_urls)) {
  ...
  for (data_type in c("gene", "epimachine", "mirna", "lncRNA", "mCpG")) {
...
for (species_code in names(data_urls)) {
  ...
  for (data_type in c("gene", "epimachine", "mirna", "lncRNA", "mCpG")) {
    ...
    # File name
    file_extension <- if (data_type %in% c("gene","epimachine","mCpG")) ".csv" else ".txt"

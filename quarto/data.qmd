...
labs <- c("Apul gene counts", "Apul miRNA counts", "Apul lncRNA counts", "Apul mCpG counts")
urls <- c(Apul_gene_url, Apul_mirna_url, Apul_lncRNA_url, Apul_mCpG_url)
...
Apul_gene |>
  ...
  slice_head(n = 4) |>
  gt() |>
  tab_caption("Preview")  # caption shown above the table
```
